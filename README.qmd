...
romeo is a minimal R package to reading, writing and validating multiscale [OME-ZARR](https://ngff.openmicroscopy.org/index.html) (or OME-NGFF) images. 
...
romeo also provides utilities for writing OME-ZARR images for OME-NGFF versions 
